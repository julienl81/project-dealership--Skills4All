 ...
 */
final class Version20221216095300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, car_category_id INT NOT NULL, nb_seats INT NOT NULL, nb_doors INT NOT NULL, name VARCHAR(255) NOT NULL, cost DOUBLE PRECISION NOT NULL, INDEX IDX_773DE69D78C4629E (car_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
